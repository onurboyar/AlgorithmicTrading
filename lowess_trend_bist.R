##### Lowes - Trend Direction Strategy Applied Only to BIST Data
# Author: Onur Boyar
...
my.lowess <- function(data, f = 0.1){
  #### function takes mktdata and the smoothing parameter, f
...
#### plots of this strategy can be found at the introductory_plots.trend.lowess.R
